...
Astriarch.Model = function(
  ...
  if (!dontPopulatePlanets) this.populatePlanets();
};
...
Astriarch.Model.GalaxySizeOptionToHexSizeMultiplier = function(galaxySize) {
  ...
  var multiplier =
    hexesInRow * Astriarch.Hexagon.Static.WIDTH +
    hexesInRow * Astriarch.Hexagon.Static.SIDE +
    Astriarch.Hexagon.Static.X;
