...
Astriarch.TradingCenter = function(playerCount) {
  this.goldAmount = playerCount ? playerCount * 5 : 10;
  ...
  this.oreResource = new Astriarch.TradingCenter.Resource(
  ...
  this.iridiumResource = new Astriarch.TradingCenter.Resource(
...
Astriarch.TradingCenter.prototype.getResourceByType = function(resourceType) {
  return resourceType == Astriarch.TradingCenter.ResourceType.FOOD
    ? this.foodResource
    : resourceType == Astriarch.TradingCenter.ResourceType.ORE
      ? this.oreResource
      : this.iridiumResource;
};
...
Astriarch.TradingCenter.Resource = function(type, amount, desiredAmount, priceMin, priceMax, tradeAmountMax) {
  ...
  this.tradeAmountMax =
    tradeAmountMax ||
    (type == Astriarch.TradingCenter.ResourceType.FOOD
      ? 40
      : type == Astriarch.TradingCenter.ResourceType.ORE
        ? 20
        : 10);
...
Astriarch.TradingCenter.TradeToString = function(trade) {
  ...
  var resourceText =
    trade.resourceType == Astriarch.TradingCenter.ResourceType.FOOD
      ? "Food"
      : trade.resourceType == Astriarch.TradingCenter.ResourceType.ORE
        ? "Ore"
        : "Iridium";
