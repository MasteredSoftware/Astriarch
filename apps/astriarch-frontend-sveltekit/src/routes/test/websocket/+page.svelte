  ...
  function connect() {
    ...
    ws.onmessage = (event) => {
      try {
        ...
        log(`📥 Received: ${getMessageTypeName(message.type)} - ${JSON.stringify(message.payload)}`);
...
<div class="container">
  ...
  <div class="card">
    <h2>Connection</h2>
    <div class="controls">
      <button on:click={connect} disabled={connected} class="btn-primary">
        Connect
      </button>
  ...
  <div class="card">
    <h2>Basic Actions</h2>
    <div class="controls">
      <button on:click={() => sendMessage(MESSAGE_TYPE.NOOP, {message: 'Hello', counter: 0})} 
              disabled={!connected} class="btn">
        Send NOOP
      </button>
      <button on:click={() => sendMessage(MESSAGE_TYPE.PING, {})} 
              disabled={!connected} class="btn">
        Send PING
      </button>
      <button on:click={() => sendMessage(MESSAGE_TYPE.LIST_GAMES, {})} 
              disabled={!connected} class="btn">
        List Games
      </button>
    </div>
  ...
  <div class="card">
    ...
    <div class="form-group">
      ...
      <button on:click={createGame} disabled={!connected} class="btn-primary">
        Create Game
      </button>
    </div>
    ...
    <div class="form-group">
      ...
      <button on:click={joinGame} disabled={!connected} class="btn-primary">
        Join Game
      </button>
    </div>
