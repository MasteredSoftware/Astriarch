			...
			{#if createGameForm}
				<div class="create-game-form">
					...
					<div class="form-group">
						...
						<select
							id="maxPlayers"
							bind:value={newGameOptions.maxPlayers}
							on:change={updateOpponentOptions}
						>
					...
					<div class="form-group checkbox">
						<label>
							<input type="checkbox" bind:checked={newGameOptions.distributePlanetsEvenly} />
					...
					<div class="form-group checkbox">
						<label>
							<input type="checkbox" bind:checked={newGameOptions.quickStart} />
							Quick Start
						</label>
					</div>
					...
					<div class="form-actions">
						<button
							on:click={createGame}
							class="btn-primary"
							disabled={!playerName.trim() || !newGameName.trim()}
						>
							Create Game
						</button>
			...
			{:else}
				<div class="games-list">
					{#if availableGames.length > 0}
						{#each availableGames as game (game._id)}
							...
							>
								...
								<div class="game-players">
									{game.players?.length || 0}/{game.gameOptions?.maxPlayers || 0} players
								</div>
						...
						{/each}
					{:else}
						<div class="no-games">No games available. Create a new game to get started!</div>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="details-panel">
			{#if selectedGame}
				<div class="game-details">
					...
					<div class="detail-section">
						<h3>
							Players ({selectedGame.players?.length || 0}/{selectedGame.gameOptions?.maxPlayers ||
								0})
						</h3>
								...
								<button
									...
									disabled={!playerName.trim() ||
										(selectedGame.players?.length || 0) >=
											(selectedGame.gameOptions?.maxPlayers || 4)}
								>
									Join Game
								</button>
							</div>
