<script lang="ts">
	...
	function getNotificationClass(type: string): string {
		switch (type) {
			...
			case 'battle':
				return 'notification-battle';
			case 'research':
				return 'notification-research';
			case 'construction':
				return 'notification-construction';
			case 'fleet':
				return 'notification-fleet';
			case 'planet':
				return 'notification-planet';
			case 'diplomacy':
				return 'notification-diplomacy';
			default:
	...
	$: notificationCounts = notifications.reduce(
		(counts, notification) => {
