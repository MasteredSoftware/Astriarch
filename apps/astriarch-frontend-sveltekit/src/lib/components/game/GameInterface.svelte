		...
		<div class="game-layout">
			...
			<div class="top-bar">
				<TopOverview resourceData={$resourceData} population={$population}>
					...
					<div class="actions-section">
						<Button size="small" variant="secondary" onclick={toggleChat}>Chat</Button>
						<Button size="small" variant="secondary" onclick={toggleNotifications}>Alerts</Button>
					</div>
				</TopOverview>
			</div>
			...
			<div class="main-content">
				...
				<div class="center-area">
					{#if currentView === 'game'}
						<GameCanvas on:planetClick={handlePlanetClick} on:fleetClick={handleFleetClick} />
