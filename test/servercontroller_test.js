...
describe("#ServerController", function() {
  ...
  describe("CalculateEndGamePoints()", function() {
    it("should base points on total points at the end of the game", function(done) {
      ...
      var points = Astriarch.ServerController.CalculateEndGamePoints(
        gameModel,
        1,
        [
          { name: "Player2", type: Astriarch.Player.PlayerType.Computer_Expert },
          { name: "Player3", type: Astriarch.Player.PlayerType.Computer_Expert },
          { name: "Player4", type: Astriarch.Player.PlayerType.Computer_Expert }
        ],
        true
      );
    ...
    it("should give less points for an easier game", function(done) {
      ...
      var points = Astriarch.ServerController.CalculateEndGamePoints(
        gameModel,
        1,
        [{ name: "Player2", type: Astriarch.Player.PlayerType.Human }],
        true
      );
