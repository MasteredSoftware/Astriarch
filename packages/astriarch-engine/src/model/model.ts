...
export enum PlanetsPerSystemOption { FOUR=4, FIVE=5, SIX=6, SEVEN=7, EIGHT=8 };

export enum GalaxySizeOption { TINY=1, SMALL=2, MEDIUM=3, LARGE=4 }; //multiplier for Astriarch.Hexagon.Static
