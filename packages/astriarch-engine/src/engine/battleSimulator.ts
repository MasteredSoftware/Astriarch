...
export type FleetDamagePending = Record<string, { starship: StarshipData; hits: PendingHit[] }>;
type ExperiencePending = Record<string, { starship: StarshipData; damageDealt: number }>;
