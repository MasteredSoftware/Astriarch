...
export interface GameCommand {
  ...
  playerId: string;
  timestamp: number;
  commandId: string; // unique ID for tracking optimistic updates and command acknowledgments
  clientCycle?: number; // Client's current cycle when command was sent (for drift compensation)
  metadata?: {
    autoQueued?: boolean; // True if this command was automatically generated by auto-queue logic
    source?: 'human' | 'ai'; // Whether command originated from human player or AI
  };
}
