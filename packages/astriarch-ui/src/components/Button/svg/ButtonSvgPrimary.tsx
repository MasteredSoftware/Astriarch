export const ButtonSvgLargePrimary = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="211" height="52" viewBox="0 0 211 52" fill="none">
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.244808" stopOpacity="0.25" />
          <stop offset="0.500575" stopOpacity="0.5" />
          <stop offset="0.761963" stopOpacity="0.25" />
...
export const ButtonSvgMediumPrimary = () => {
  return (
...
export const ButtonSvgSmallPrimary = () => {
  return (
